  ...
  "CRAFT": {
    ...
    "milestones": [{
      ...
      "signals": [
        ...
        "Uses existing observability tools to detect and resolve issues",
      ],
      "examples": [
      ...
      "signals": [
        ...
        "Adds to existing system observability",
      ],
      "examples": [
      ...
      "signals": [
        ...
        "Establishes tooling and design for system observability",
      ],
      "examples": [
...
export const titles = [
  {label: 'NA', minPoints: 0, maxPoints: 1024},
